...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  double get _estimatedDepositAmount => widget.servicePrice * 0.20;

  Future<void> _handlePayment() async {
    if (widget.stylistStripeAccountId == null ||
        widget.stylistStripeAccountId!.trim().isEmpty) {
      setState(() {
        _errorMessage =
            'This stylist is not ready for in-app payments yet. Please choose another stylist or try again later.';
      });
      return;
    }
    ...
    try {
      final payment = await StripeService().chargeBookingDeposit(
                ...
                child: IntrinsicHeight(
                  child: Column(
                    ...
                    children: [
                      ...
                      _PriceBreakdown(
                        servicePrice: widget.servicePrice,
                        depositAmount: _estimatedDepositAmount,
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                ...
                                'Stripe confirms the final charge before payment.',
                                style: TextStyle(
                                  fontSize: 13,
    ...
    return Column(
      ...
      children: [
        ...
        _Row(
          ...
          value: currencyFormat.format(servicePrice),
        ),
        const SizedBox(height: 8),
        _Row(
          label: 'Estimated deposit due now (20%)',
